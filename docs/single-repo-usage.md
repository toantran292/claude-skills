...
Produces a system design proposal: architecture flow, affected modules, risks, and validation strategy. The design is saved to `.claude/designs/` so `/implement-ticket` can read it — even in a new conversation.
