...
`/design-feature` saves its output to `.claude/designs/`. When you open each repo and run `/implement-ticket`, it reads the saved design file automatically — even in a new conversation.
